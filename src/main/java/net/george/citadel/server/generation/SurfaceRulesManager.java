...
public class SurfaceRulesManager {
    public static final List<MaterialRules.MaterialRule> OVERWORLD_REGISTRY = new ArrayList<>();
    public static final List<MaterialRules.MaterialRule> NETHER_REGISTRY = new ArrayList<>();
    public static final List<MaterialRules.MaterialRule> END_REGISTRY = new ArrayList<>();
    public static final List<MaterialRules.MaterialRule> CAVE_REGISTRY = new ArrayList<>();

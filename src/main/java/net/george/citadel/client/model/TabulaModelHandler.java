...
import net.george.citadel.client.model.container.TabulaCubeContainer;
import net.george.citadel.client.model.container.TabulaCubeGroupContainer;
import net.george.citadel.client.model.container.TabulaModelBlock;
import net.george.citadel.client.model.container.TabulaModelContainer;
 ...
 * @since 1.0.0
 */
@SuppressWarnings({"deprecation", "unused", "MismatchedQueryAndUpdateOfCollection"})
...
public enum TabulaModelHandler implements JsonDeserializationContext {
    ...
    private final Gson GSON = new GsonBuilder()
            ...
            .registerTypeAdapter(ModelTransformation.class, new ModelTransformation.Deserializer()).create();
    private final JsonParser parser = new JsonParser();
    private final TabulaModelBlock.Deserializer deserializer = new TabulaModelBlock.Deserializer();
    private ResourceManager manager;
    private final Set<String> enabledDomains = new HashSet<>();

    public void addDomain(String domain) {
        this.enabledDomains.add(domain.toLowerCase(Locale.ROOT));
        Citadel.LOGGER.info("TabulaModelHandler: Domain {} has been added.", domain.toLowerCase(Locale.ROOT));
  ...
  /*  @Override
    ...
    public IUnbakedModel loadModel(ResourceLocation modelLocation) throws Exception {
        ...
        jsonStream.close();
        TabulaModelBlock TabulaModelBlock = this.deserializer.deserialize(json, TabulaModelBlock.class, this);
